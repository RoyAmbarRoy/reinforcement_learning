...
for lr in lr_list:
    ...
    policy = PolicyNetwork(state_size, action_size, lr)
    tf.summary.merge_all()

    print('Learning rate = ' + str(lr))
    file_writer = tf.summary.FileWriter(PATH_LOG+'/lr='+str(lr), tf.get_default_graph())
    ...
    with tf.Session() as sess:
        ...
        for episode in range(max_episodes):
            ...
            file_writer.add_summary(creators.create_summary('loss policy', avg_loss), episode)
